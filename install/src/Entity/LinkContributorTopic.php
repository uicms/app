...
/**
 * @ORM\Entity(repositoryClass="App\Repository\LinkContributorTopicRepository")
 */
class LinkContributorTopic 
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\LinkContributorTopic")
...
/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Contributor", inversedBy="link_contributor_topic")
        	 * @ORM\JoinColumn(name="contributor_id", referencedColumnName="id")
        	 */
        	private $contributor;

/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Topic", inversedBy="link_contributor_topic")
