...
/**
 * @ORM\Entity(repositoryClass="App\Repository\LinkVenueMediaRepository")
 */
class LinkVenueMedia 
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\LinkVenueMedia")
...
/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Venue", inversedBy="link_venue_media")
        	 * @ORM\JoinColumn(name="venue_id", referencedColumnName="id")
        	 */
        	private $venue;

/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Media", inversedBy="link_venue_media")
