...
/**
 * @ORM\Entity(repositoryClass="App\Repository\LinkContributorGradePageRepository")
 */
class LinkContributorGradePage 
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\LinkContributorGradePage")
...
/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\ContributorGrade", inversedBy="link_contributor_grade_page")
        	 * @ORM\JoinColumn(name="contributor_grade_id", referencedColumnName="id")
        	 */
        	private $contributor_grade;

/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Page", inversedBy="link_contributor_grade_page")
