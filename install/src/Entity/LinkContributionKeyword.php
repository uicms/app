...
/**
 * @ORM\Entity(repositoryClass="App\Repository\LinkContributionKeywordRepository")
 */
class LinkContributionKeyword 
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\LinkContributionKeyword")
...
/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Contribution", inversedBy="link_contribution_keyword")
        	 * @ORM\JoinColumn(name="contribution_id", referencedColumnName="id")
        	 */
        	private $contribution;

/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Keyword", inversedBy="link_contribution_keyword")
