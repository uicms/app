...
/**
 * @ORM\Entity(repositoryClass="App\Repository\LinkPageMediaRepository")
 */
class LinkPageMedia 
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\LinkPageMedia")
...
/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Page", inversedBy="link_page_media")
        	 * @ORM\JoinColumn(name="page_id", referencedColumnName="id")
        	 */
        	private $page;

/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Media", inversedBy="link_page_media")
