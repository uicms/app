...
/**
 * @ORM\Entity(repositoryClass="App\Repository\LinkEventKeywordRepository")
 */
class LinkEventKeyword 
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\LinkEventKeyword")
...
/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Event", inversedBy="link_event_keyword")
        	 * @ORM\JoinColumn(name="event_id", referencedColumnName="id")
        	 */
        	private $event;

/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Keyword", inversedBy="link_event_keyword")
