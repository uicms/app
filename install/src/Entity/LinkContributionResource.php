...
/**
 * @ORM\Entity(repositoryClass="App\Repository\LinkContributionResourceRepository")
 */
class LinkContributionResource 
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\LinkContributionResource")
...
/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Contribution", inversedBy="link_contribution_resource")
        	 * @ORM\JoinColumn(name="contribution_id", referencedColumnName="id")
        	 */
        	private $contribution;

/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Resource", inversedBy="link_contribution_resource")
