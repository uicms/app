...
/**
 * @ORM\Entity(repositoryClass="App\Repository\LinkEventVenueRepository")
 */
class LinkEventVenue 
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\LinkEventVenue")
...
/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Event", inversedBy="link_event_venue")
        	 * @ORM\JoinColumn(name="event_id", referencedColumnName="id")
        	 */
        	private $event;

/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Venue", inversedBy="link_event_venue")
