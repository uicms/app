...
/**
 * @ORM\Entity(repositoryClass="App\Repository\LinkBlockMediaRepository")
 */
class LinkBlockMedia 
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\LinkBlockMedia")
...
/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Block", inversedBy="link_block_media")
        	 * @ORM\JoinColumn(name="block_id", referencedColumnName="id")
        	 */
        	private $block;

/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Media", inversedBy="link_block_media")
