...
/**
 * @ORM\Entity(repositoryClass="App\Repository\LinkEventMediaRepository")
 */
class LinkEventMedia 
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\LinkEventMedia")
...
/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Event", inversedBy="link_event_media")
        	 * @ORM\JoinColumn(name="event_id", referencedColumnName="id")
        	 */
        	private $event;

/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Media", inversedBy="link_event_media")
