...
/**
 * @ORM\Entity(repositoryClass="App\Repository\LinkResourceKeywordRepository")
 */
class LinkResourceKeyword 
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\LinkResourceKeyword")
...
/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Resource", inversedBy="link_resource_keyword")
        	 * @ORM\JoinColumn(name="resource_id", referencedColumnName="id")
        	 */
        	private $resource;

/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Keyword", inversedBy="link_resource_keyword")
