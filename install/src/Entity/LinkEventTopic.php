...
/**
 * @ORM\Entity(repositoryClass="App\Repository\LinkEventTopicRepository")
 */
class LinkEventTopic 
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\LinkEventTopic")
...
/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Event", inversedBy="link_event_topic")
        	 * @ORM\JoinColumn(name="event_id", referencedColumnName="id")
        	 */
        	private $event;

/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Topic", inversedBy="link_event_topic")
