...
/**
 * @ORM\Entity(repositoryClass="App\Repository\LinkEventContributorRepository")
 */
class LinkEventContributor 
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\LinkEventContributor")
...
/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Event", inversedBy="link_event_contributor")
        	 * @ORM\JoinColumn(name="event_id", referencedColumnName="id")
        	 */
        	private $event;

/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Contributor", inversedBy="link_event_contributor")
