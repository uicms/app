...
/**
 * @ORM\Entity(repositoryClass="App\Repository\LinkPageBlockRepository")
 */
class LinkPageBlock 
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\LinkPageBlock")
...
/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Page", inversedBy="link_page_block")
        	 * @ORM\JoinColumn(name="page_id", referencedColumnName="id")
        	 */
        	private $page;

/**
        	 * @ORM\ManyToOne(targetEntity="App\Entity\Block", inversedBy="link_page_block")
